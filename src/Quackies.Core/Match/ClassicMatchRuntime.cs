...
namespace Quackies.Core.Match
{
    ...
    /// </summary>
    internal sealed class ClassicMatchRuntime : IMatchRuntime<MatchView>
    {
        ...
        private ClassicMatchRuntime(IRandomSource random, RuleSet rules, MatchSettings settings)
        {
        ...
        public static ClassicMatchRuntime Create(IRandomSource random, RuleSet? rules = null) =>
            new ClassicMatchRuntime(random, rules ?? RuleSet.SetOne(), MatchSettings.Standard);

        public static ClassicMatchRuntime Create(IRandomSource random, MatchSettings settings, RuleSet? rules = null) =>
            new ClassicMatchRuntime(random, rules ?? RuleSet.SetOne(), settings);

        public string ActionWindow => $"{Round}:{Phase}";
